...
Section:NewButton("Get OWL HUB", "ButtonInfo", function()
...
local Tab = Window:NewTab("All star")
local Section = Tab:NewSection("River Hub")

Section:NewButton("Get River hub", "ButtonInfo", function()
    pcall(function()
        loadstring(game:HttpGet("http://riverhub.xyz/" .. tostring(game.PlaceId) .. ".lua"))()
     end)
end)
local Tab = Window:NewTab("Pet X sim")
local Section = Tab:NewSection("Petsi X hub")

Section:NewButton("Get Petsi X hub", "ButtonInfo", function()
...
local Tab = Window:NewTab("Bedwar")
local Section = Tab:NewSection("VAPE hub")

Section:NewButton("Get VAPE hub", "ButtonInfo", function()
...
local Section = Tab:NewSection("Strawhook hub")

Section:NewButton("Get Strawhook hub", "ButtonInfo", function()
